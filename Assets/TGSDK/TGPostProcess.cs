...
namespace Together {
	...
	public static class TGPostProcess {
		...
		internal static void CopyAndReplaceFile(string srcPath, string dstPath, string filePath) {
	    ...
	    public static void OnPostProcessBuild( BuildTarget buildTarget, string pathToBuiltProject ) {
			...
			if (buildTarget == BuildTarget.iPhone) {
				...
				string basePatch = "TGSDK/Plugins/1.8.1/iOS/";
				...
				libFiles.Add("libTGSDK.1.8.1.a");
					
				foreach (string file in libFiles) {
					CopyAndReplaceFile("Assets/"+basePatch+file, libPath, file);
					string fileGuid  = proj.AddFile(libPath+file,"Libraries/"+basePatch+file,PBXSourceTree.Source);
				...
				foreach (string file in frameworkFiles) {
					CopyAndReplaceDirectory("Assets/"+basePatch+file, sdkPath+file);
				...
				foreach (string file in singleFiles) {
					CopyAndReplaceFile("Assets/"+basePatch+file, sdkPath, file);
					string fileGuid  = proj.AddFile(sdkPath+file,"Frameworks/"+basePatch+file,PBXSourceTree.Source);
					proj.AddFileToBuild(target, fileGuid);
				}
